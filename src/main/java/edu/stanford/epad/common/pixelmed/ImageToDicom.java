...
//System.err.println("ImageToDicom.generateDICOMPixelModuleFromConsumerImageFile(): JPEG, so setting bitsPerSample = "+bitsPerSample);
	...
	/**
	 * version for ePAD, gives more control to the caller to set the tags with UIDs and descriptions
	 * @param inputFile
	 * @param outputFile
	 * @param patientName
	 * @param patientID
	 ...
	 */
	public ImageToDicom(String inputFile,String outputFile,String patientName,String patientID,String studyID,String seriesNumber,String instanceNumber, String studyUID, String seriesUID, String studyDescription, String seriesDescription)
			throws IOException, DicomException {
		this(inputFile,outputFile,patientName,patientID,studyID,seriesNumber,instanceNumber,null,null,studyUID,seriesUID,studyDescription,seriesDescription);
	}
	/**
	...
	public ImageToDicom(String inputFile,String outputFile,String patientName,String patientID,String studyID,String seriesNumber,String instanceNumber,String modality,String sopClass) 
			throws IOException, DicomException{
		this(inputFile,outputFile,patientName,patientID,studyID,seriesNumber,instanceNumber,null,null,null,null,null,null);		
	 ...
	 * @throws DicomException
	 */
	public ImageToDicom(String inputFile,String outputFile,String patientName,String patientID,String studyID,String seriesNumber,String instanceNumber,String modality,String sopClass, String studyUID, String seriesUID, String studyDescription, String seriesDescription)
			throws IOException, DicomException {
...
//		{ Attribute a = new UniqueIdentifierAttribute(TagFromName.StudyInstanceUID); a.addValue(u.getNewStudyInstanceUID(studyID)); list.put(a); }
		...
		{ Attribute a = new UniqueIdentifierAttribute(TagFromName.SeriesInstanceUID); a.addValue(seriesUID); list.put(a); }
		{ Attribute a = new UniqueIdentifierAttribute(TagFromName.StudyInstanceUID); a.addValue(studyUID); list.put(a); }

		{ Attribute a = new UniqueIdentifierAttribute(TagFromName.SeriesDescription); a.addValue(seriesDescription); list.put(a); }
		{ Attribute a = new UniqueIdentifierAttribute(TagFromName.StudyDescription); a.addValue(studyDescription); list.put(a); }
