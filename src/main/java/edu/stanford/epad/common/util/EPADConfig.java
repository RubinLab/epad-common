...
public class EPADConfig
{
	...
	public static final String templateXSDPath = EPADConfig.getInstance().getStringPropertyValue("baseSchemaDir") + EPADConfig.getInstance().getParamValue("xsdFileTemplate", "AIMTemplate_v2rvStanford.xsd");
