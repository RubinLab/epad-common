 ...
 * 
 * This code is from the epad1909 project package br.usp.icmc.biomac.client.view.utils.AimUtils;
 * 
 * 
 * We are going to ask Hakan to add these to the AIMv3API since they are usef
 * 
 * Date: 9/28/12
 */
public class AimUtils
{
	...
	/**
	 * is this a spline shape? default to spline for a polyline for now because the linestyle is not saving 'curve' and
	 * 'normal'
	 * 
	 * @param ia
	 * @return
