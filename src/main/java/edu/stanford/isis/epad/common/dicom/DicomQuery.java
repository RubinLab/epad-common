 ...
 * Make a DicomQuery.
 * <p>
 * The following methods are used to build the arguments for the DcmQr method call.
 * </p>
 * <ul>
...
public class DicomQuery
{
	...
	public static DicomSearchResult searchForSeries(String studyUID, String remoteAddr)
	{
		...
		if (result == null) {
			...
			throw new IllegalStateException("Failed to find the root search for: studyUID=" + studyUID + " remoteAddr="
					+ remoteAddr + " searchResultCache=" + searchResultCache);
		}
	...
	/**
	 * Return a list of instances, based on a series instance UID (Can't find any calls to this method).
	 * 
	 * @param seriesUID
	 * @return
	 */
	 ...
	 * 
	 * This routine needs to look for "Query Response #" and then It needs to parse tags until the next
	 * "Query Response #", or a line that has no tags.
	 * 
	 * An example log is below.
	 * 
	 * 5 sec. ,Info: Connected to DCM4CHEE@171.65.102.125:11112 in 0.134 s 5 sec. ,Info: Send Query Request using
	 * 1.2.840.10008.5.1.4.1.2.2.1/Study Root Query/Retrieve Information Model - FIND: (0008,0020) DA #0 [] Study Date
	 * (0008,0030) TM #0 [] Study Time (0008,0050) SH #0 [] Accession Number (0008,0052) CS #6 [STUDY] Query/Retrieve
	 * Level (0008,0061) CS #0 [] Modalities in Study (0010,0010) PN #0 [] Patient's Name (0010,0020) LO #38
	 * [83393488148532965622665512597663741359] Patient ID (0020,000D) UI #0 [] Study Instance UID (0020,0010) SH #0 []
	 * Study ID (0020,1206) IS #0 [] Number of Study Related Series (0020,1208) IS #0 [] Number of Study Related Instances
	 * 
	 * 5 sec. ,Info: Query Response #1: (0008,0020) DA #8 [20110110] Study Date (0008,0030) TM #6 [095705] Study Time
	 * (0008,0050) SH #8 [5989569] Accession Number (0008,0052) CS #6 [STUDY] Query/Retrieve Level (0008,0054) AE #8
	 * [DCM4CHEE] Retrieve AE Title (0008,0056) CS #6 [ONLINE] Instance Availability (0008,0061) CS #2 [CR] Modalities in
	 * Study (0010,0010) PN #16 [PTL-1-132-833934] Patient's Name (0010,0020) LO #38
	 * [83393488148532965622665512597663741359] Patient ID (0020,000D) UI #64
	 * [1.2.826.0.1.3680043.8.420.20881664157860029483433361314058674184] Study Instance (0020,0010) SH #8 [5989569] Study
	 * ID (0020,1206) IS #2 [2] Number of Study Related Series (0020,1208) IS #2 [2] Number of Study Related Instances
	 * (0088,0130) SH #0 [] Storage Media File-set ID (0088,0140) UI #0 [] Storage Media File-set UID
	 * 
	 * 5 sec. ,Info: Received 1 matching entries in 0.054 s 5 sec. ,Info: Released connection to
	 ...
	 * 
	 * 
	 11:03:24,816 INFO - Query Response #22 for Query Request #4/61: (0008,0005) CS #10 [ISO_IR 100] Specific Character
	 * Set (0008,0016) UI #26 [1.2.840.10008.5.1.4.1.1.4] SOP Class UID (0008,0018) UI #64
	 * [1.2.826.0.1.3680043.8.420.30985929668125050082535509534643661667] SOP Instance U (0008,0022) DA #0 [] Acquisition
	 * Date (0008,0023) DA #0 [] Content Date (0008,002A) DT #0 [] Acquisition DateTime (0008,0052) CS #6 [IMAGE]
	 * Query/Retrieve Level (0008,0054) AE #8 [DCM4CHEE] Retrieve AE Title (0008,0056) CS #6 [ONLINE] Instance
	 * Availability (0020,000D) UI #64 [1.2.826.0.1.3680043.8.420.17864099421429702484295733867604129208] Study Instance
	 * (0020,000E) UI #64 [1.2.826.0.1.3680043.8.420.16088526745603431705311736218566340373] Series Instanc (0020,0013) IS
	 * #2 [23] Instance Number (0088,0130) SH #0 [] Storage Media File-set ID (0088,0140) UI #0 [] Storage Media File-set
	 * UID
	 * 
	 * 11:03:24,816 INFO - Query Response #23 for Query Request #4/61: (0008,0005) CS #10 [ISO_IR 100] Specific Character
	 * Set (0008,0016) UI #26 [1.2.840.10008.5.1.4.1.1.4] SOP Class UID (0008,0018) UI #64
	 * [1.2.826.0.1.3680043.8.420.14882538330581136693695353976522568667] SOP Instance U (0008,0022) DA #0 [] Acquisition
	 * Date (0008,0023) DA #0 [] Content Date (0008,002A) DT #0 [] Acquisition DateTime (0008,0052) CS #6 [IMAGE]
	 * Query/Retrieve Level (0008,0054) AE #8 [DCM4CHEE] Retrieve AE Title (0008,0056) CS #6 [ONLINE] Instance
	 * Availability (0020,000D) UI #64 [1.2.826.0.1.3680043.8.420.17864099421429702484295733867604129208] Study Instance
	 * (0020,000E) UI #64 [1.2.826.0.1.3680043.8.420.16088526745603431705311736218566340373] Series Instanc (0020,0013) IS
	 * #2 [14] Instance Number (0088,0130) SH #0 [] Storage Media File-set ID (0088,0140) UI #0 [] Storage Media File-set
	 * UID
	 * 
	 * @return
	 */
	 ...
	 * 
	 * @param seriesUID
	 * @return array of strings containing cli request broken into words by splitting on spaces
	 */
	 ...
	 * 
	 * <p>
	 * ./dcmqr DCM4CHEE@171.65.102.125:11112 -L 171.65.102.233:4096 -r PatientName -q
	 * StudyInstanceUID=1.2.826.0.1.3680043.8.420.17864099421429702484295733867604129208 -S -r SeriesDate -r
	 * AcquisitionDate -r ContentDate -r AcquisitionDateTime -r Modality
	 * </p>
	 * 
	...
	/**
	 * These are some extra parameter needed as -r in the DicomQuery. Create a set to determine which ones are needed
	 * depending on the search type since -r and -q parameters cannot be duplicate.
	 * 
	 * @return
	 */
	...
	public static enum QueryRetrieveLevel {
		PATIENT("PATIENT", PATIENT_RETURN_KEYS, PATIENT_LEVEL_FIND_CUID, PATIENT_LEVEL_GET_CUID, PATIENT_LEVEL_MOVE_CUID), STUDY(
				"STUDY", STUDY_RETURN_KEYS, STUDY_LEVEL_FIND_CUID, STUDY_LEVEL_GET_CUID, STUDY_LEVEL_MOVE_CUID), SERIES(
				"SERIES", SERIES_RETURN_KEYS, SERIES_LEVEL_FIND_CUID, SERIES_LEVEL_GET_CUID, SERIES_LEVEL_MOVE_CUID), IMAGE(
				"IMAGE", INSTANCE_RETURN_KEYS, SERIES_LEVEL_FIND_CUID, SERIES_LEVEL_GET_CUID, SERIES_LEVEL_MOVE_CUID);
	...
	private static final String[] STUDY_LEVEL_FIND_CUID = { UID.StudyRootQueryRetrieveInformationModelFIND,
			UID.PatientRootQueryRetrieveInformationModelFIND, UID.PatientStudyOnlyQueryRetrieveInformationModelFINDRetired };
	...
	private static final String[] STUDY_LEVEL_MOVE_CUID = { UID.StudyRootQueryRetrieveInformationModelMOVE,
			UID.PatientRootQueryRetrieveInformationModelMOVE, UID.PatientStudyOnlyQueryRetrieveInformationModelMOVERetired };
	...
	private static enum TS {
		IVLE(IVRLE_TS), LE(NATIVE_LE_TS), BE(NATIVE_BE_TS), DEFL(DEFLATED_TS), JPLL(JPLL_TS), JPLY(JPLY_TS), MPEG2(MPEG2_TS), NOPX(
				NOPX_TS), NOPXD(NOPXDEFL_TS);
	...
	private static enum CUID {
		CR(UID.ComputedRadiographyImageStorage), CT(UID.CTImageStorage), MR(UID.MRImageStorage), US(
				UID.UltrasoundImageStorage), NM(UID.NuclearMedicineImageStorage), PET(
				UID.PositronEmissionTomographyImageStorage), SC(UID.SecondaryCaptureImageStorage), XA(
				UID.XRayAngiographicImageStorage), XRF(UID.XRayRadiofluoroscopicImageStorage), DX(
				UID.DigitalXRayImageStorageForPresentation), MG(UID.DigitalMammographyXRayImageStorageForPresentation), PR(
				UID.GrayscaleSoftcopyPresentationStateStorageSOPClass), KO(UID.KeyObjectSelectionDocumentStorage), SR(
	...
	private final List<String> privateFind = new ArrayList<String>();
	...
	private static CommandLine parse(String[] args) throws IllegalArgumentException
	{
		...
		OptionBuilder.withDescription("negotiate support of specified Storage SOP Class and Transfer "
				...
				+ "The Transfer Syntaxes may be specified by a comma " + "separated list of UIDs or by one of following key "
				...
				+ "If only the Storage SOP Class is specified, all " + "Transfer Syntaxes listed above except No Pixel Data "
	...
	public static void mainOrig(String[] args)
	{
		...
		DicomQuery dcmqr = new DicomQuery(cl.hasOption("device") ? cl.getOptionValue("device") : "DCMQR");
		...
		if (cl.hasOption("connectTO"))
			dcmqr.setConnectTimeout(parseInt(cl.getOptionValue("connectTO"), "illegal argument of option -connectTO", 1,
					Integer.MAX_VALUE));
		if (cl.hasOption("reaper"))
			dcmqr.setAssociationReaperPeriod(parseInt(cl.getOptionValue("reaper"), "illegal argument of option -reaper", 1,
					Integer.MAX_VALUE));
		if (cl.hasOption("cfindrspTO"))
			dcmqr.setDimseRspTimeout(parseInt(cl.getOptionValue("cfindrspTO"), "illegal argument of option -cfindrspTO", 1,
					Integer.MAX_VALUE));
		if (cl.hasOption("cmoverspTO"))
			dcmqr.setRetrieveRspTimeout(parseInt(cl.getOptionValue("cmoverspTO"), "illegal argument of option -cmoverspTO",
					1, Integer.MAX_VALUE));
		if (cl.hasOption("cgetrspTO"))
			dcmqr.setRetrieveRspTimeout(parseInt(cl.getOptionValue("cgetrspTO"), "illegal argument of option -cgetrspTO", 1,
					Integer.MAX_VALUE));
		...
		if (cl.hasOption("releaseTO"))
			dcmqr.setReleaseTimeout(parseInt(cl.getOptionValue("releaseTO"), "illegal argument of option -releaseTO", 1,
					Integer.MAX_VALUE));
		if (cl.hasOption("soclosedelay"))
			dcmqr.setSocketCloseDelay(parseInt(cl.getOptionValue("soclosedelay"), "illegal argument of option -soclosedelay",
					1, 10000));
		if (cl.hasOption("rcvpdulen"))
			dcmqr.setMaxPDULengthReceive(parseInt(cl.getOptionValue("rcvpdulen"), "illegal argument of option -rcvpdulen", 1,
					10000) * KB);
		if (cl.hasOption("sndpdulen"))
			dcmqr.setMaxPDULengthSend(parseInt(cl.getOptionValue("sndpdulen"), "illegal argument of option -sndpdulen", 1,
					10000) * KB);
		if (cl.hasOption("sosndbuf"))
			dcmqr.setSendBufferSize(parseInt(cl.getOptionValue("sosndbuf"), "illegal argument of option -sosndbuf", 1, 10000)
					* KB);
		if (cl.hasOption("sorcvbuf"))
			dcmqr.setReceiveBufferSize(parseInt(cl.getOptionValue("sorcvbuf"), "illegal argument of option -sorcvbuf", 1,
					10000) * KB);
		if (cl.hasOption("filebuf"))
			dcmqr.setFileBufferSize(parseInt(cl.getOptionValue("filebuf"), "illegal argument of option -filebuf", 1, 10000)
					* KB);
		...
		int repeat = cl.hasOption("repeat") ? parseInt(cl.getOptionValue("repeat"), "illegal argument of option -repeat",
	...
	public void configureTransferCapability(boolean ivrle)
	{
		...
		TransferCapability[] tcs = new TransferCapability[findcuids.length + privateFind.size() + movecuids.length
				+ getcuids.length + storeTransferCapability.size()];
		int i = 0;
	...
	private List<DicomObject> queryUpperLevelUIDs(String cuid, String tsuid) throws IOException, InterruptedException
	{
		...
		if (Arrays.asList(PATIENT_LEVEL_FIND_CUID).contains(cuid)) {
			...
			keylist = queryStudyOrSeriesIUIDs(cuid, tsuid, keylist, Tag.StudyInstanceUID, STUDY_MATCHING_KEYS,
					QueryRetrieveLevel.STUDY);
		} else {
			keylist.add(new BasicDicomObject());
			keylist = queryStudyOrSeriesIUIDs(cuid, tsuid, keylist, Tag.StudyInstanceUID, PATIENT_STUDY_MATCHING_KEYS,
					QueryRetrieveLevel.STUDY);
		}
		if (qrlevel == QueryRetrieveLevel.IMAGE) {
			keylist = queryStudyOrSeriesIUIDs(cuid, tsuid, keylist, Tag.SeriesInstanceUID, SERIES_MATCHING_KEYS,
	...
	private static InputStream openFileOrURL(String url) throws IOException
	{
		if (url.startsWith("resource:")) {
			return DicomQuery.class.getClassLoader().getResourceAsStream(url.substring(9));
		}
		try {
