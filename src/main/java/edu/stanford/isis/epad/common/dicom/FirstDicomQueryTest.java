 ...
 * 
 * This is based on DCM4CHEE - "DcmQR.java"
 */
public class FirstDicomQueryTest implements Runnable
{
	@Override
	public void run()
	{
		try {
			// Give a patient on rufus, try to get a list of studyUIDs and seriesUIDs for it.
			String[] args = createArgs();

			// Will need to do something like call main.
			FirstDicomQueryTest.mainOrig(args);
	...
	/**
	 * This is a new main just for testing.
	 * 
	 * @param args
	 */
	...
	/**
	 * Theses values are from the config.
	 * 
	 * 
	 * @return
	 */
	...
	{
		return "DCM4CHEE@171.65.102.125:11112 -L 171.65.102.233:4096 -r PatientID -r PatientName".split(" ");
	}
	 ...
	 * @param name
	 */
	public FirstDicomQueryTest(String name)
	{
	...
	public static void mainOrig(String[] args)
	{
		...
		FirstDicomQueryTest dcmqr = new FirstDicomQueryTest(cl.hasOption("device") ? cl.getOptionValue("device") : "DCMQR");
	...
	private final DimseRSPHandler rspHandler = new DimseRSPHandler() {
		...
		{
			FirstDicomQueryTest.this.onMoveRSP(as, cmd, data);
		}
	};
	...
	private static InputStream openFileOrURL(String url) throws IOException
	{
		if (url.startsWith("resource:")) {
			return FirstDicomQueryTest.class.getClassLoader().getResourceAsStream(url.substring(9));
		}
		try {
