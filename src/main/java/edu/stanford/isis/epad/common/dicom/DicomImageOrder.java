 ...
 * file.
 */
public class DicomImageOrder implements Comparable<DicomImageOrder>
{
	...
	public DicomImageOrder(int instanceNumber, String imageUID, Map<String, String> tags)
	{
	...
	@Override
	public int compareTo(DicomImageOrder imageOrder)
	{
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof DicomImageOrder)) {
			return false;
		}
		DicomImageOrder that = (DicomImageOrder)o;
